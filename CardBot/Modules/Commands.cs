...
namespace CardBot.Bot.Modules
{
    public class Commands : ModuleBase<SocketCommandContext>
    {
        ...
        //    var oldMessage = Context.Message.ReferencedMessage;

        //    using (var db = new CardContext())
        //    {
        //        var giving = db.CardGivings.FirstOrDefault(c => c.MessageId == oldMessage.Id);

        //        if (null == giving) NewChallenge(newColor, reason);
        //    }
        ...
        private void NewChallenge(string newColor, string[] reason)
        {
